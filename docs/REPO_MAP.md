...
- func `set_mode` (L72)
- func `get_mode` (L82)
- func `get_mode_name` (L86)
- func `get_mode_desc` (L90)
- func `is_visible` (L95)
- func `is_simple` (L100)
- func `is_exhaustive` (L105)
...
- func `draw_typed_pins` (L243)
- func `draw_exec_connection` (L296)
- func `hit_test_bp_pins` (L325)
- func `hit_test_bp_node` (L345)
