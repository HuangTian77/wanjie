...
- func `to_dict` (L50)
- func `from_dict` (L76)
- func `get_inspiration_display` (L107)
- func `get_creation_energy_display` (L111)
- func `can_enter_script` (L115)
- func `consume_inspiration` (L119)
- func `can_create_script` (L126)
- func `consume_creation_energy` (L130)
