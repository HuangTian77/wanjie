...
- func `set_mode` (L56)
- func `get_mode` (L66)
- func `get_mode_name` (L70)
- func `get_mode_desc` (L74)
- func `is_visible` (L79)
- func `is_simple` (L84)
- func `is_exhaustive` (L89)
...
- func `draw_typed_pins` (L226)
- func `draw_exec_connection` (L279)
- func `hit_test_bp_pins` (L308)
- func `hit_test_bp_node` (L328)
