...
- class_name **UserData**
- func `reset_to_defaults` (L57)
- func `to_dict` (L68)
- func `from_dict` (L97)
- func `get_inspiration_display` (L128)
- func `get_creation_energy_display` (L132)
- func `can_enter_script` (L136)
- func `consume_inspiration` (L140)
- func `can_create_script` (L147)
- func `consume_creation_energy` (L151)
...
- func `add_labeled_field` (L287)
- func `add_multiline_field` (L290)
- func `add_spin_field` (L316)
- func `add_button` (L335)
- func `field_label` (L343)
- func `add_list_editor` (L348)
- func `add_dict_editor` (L511)
...
- func `player_use_skill` (L125)
- func `try_flee` (L223)
- func `get_log` (L331)
- func `get_rewards` (L335)
...
- func `_ready` (L69)
- func `settings_auto_save_interval_min` (L86)
- func `_process` (L94)
